...
public class NoticeListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        apiInterface = ApiClient.getClient(NoticeListActivity.this).create(ApiInterface.class);
        ...
        getAllNotice(student.getSubscribed_group_id());
        ...
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                startActivity(new Intent(getBaseContext(), NoticeDetailsActivity.class).putExtra("notice", notice).putExtra("from", "group"));
    ...
    private void getAllNotice(String id) {
        ...
        apiInterface.getAllNotice(id).enqueue(new Callback<JsonObject>() {
            @Override
